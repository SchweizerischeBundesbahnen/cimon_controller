...
class TestClewareAmpel(TestCase):
    ...
    def test_no_flash_negative_interval(self):
        ...
        # should be 9 or 10 calls depending on computing time... usually 10
        self.assertEquals(self.ampel.__output_to_cleware__.call_count, 1)

    def create_cleware_ampel(self, flash_interval_sec=0.2):
        ampel = ClewareAmpel(flash_interval_sec=flash_interval_sec)
